...
# installed.
TCL_PREFIX='D:/AI and Data Science Projects/ai-smart-retail-intelligence-platform/venv\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='D:/AI and Data Science Projects/ai-smart-retail-intelligence-platform/venv\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='D:/AI and Data Science Projects/ai-smart-retail-intelligence-platform/venv\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-ID:/AI and Data Science Projects/ai-smart-retail-intelligence-platform/venv\Library\include'
...
TCL_PACKAGE_PATH='D:/AI and Data Science Projects/ai-smart-retail-intelligence-platform/venv\Library\lib'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LD:/AI and Data Science Projects/ai-smart-retail-intelligence-platform/venv\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='D:/AI and Data Science Projects/ai-smart-retail-intelligence-platform/venv\Library\lib\tclstub86.lib'
